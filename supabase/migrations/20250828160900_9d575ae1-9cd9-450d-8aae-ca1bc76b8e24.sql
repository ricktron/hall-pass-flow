...
-- 1. Drop and recreate the get_analytics_frequent_flyers function to include avg_minutes_per_trip
DROP FUNCTION IF EXISTS get_analytics_frequent_flyers(TEXT);
