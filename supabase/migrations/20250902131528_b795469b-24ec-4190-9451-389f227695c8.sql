...
-- Drop and recreate Hall_Passes view with proper security settings
DROP VIEW IF EXISTS public."Hall_Passes";
...
-- Drop and recreate Hall_Passes_api view with proper security settings  
DROP VIEW IF EXISTS public."Hall_Passes_api";
...
-- Grant permissions on student_name_synonyms table to authenticated role
GRANT ALL ON public.student_name_synonyms TO authenticated;

-- Grant permissions on students table to authenticated role  
GRANT ALL ON public.students TO authenticated;

-- Grant permissions on bathroom_passes table to authenticated role
