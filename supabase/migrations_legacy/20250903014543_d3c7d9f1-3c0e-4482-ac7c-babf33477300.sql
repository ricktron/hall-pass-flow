-- =================================================================
-- COMPLETE ANALYTICS SYSTEM REBUILD - FINAL COMPREHENSIVE RESET (SYNTAX FIXED)
-- This migration completely rebuilds all analytics views and functions
-- Fixes all syntax errors including missing parenthesis
-- =================================================================
...
-- Step 3: Create all windowed views with proper syntax
